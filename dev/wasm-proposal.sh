...
FXCHAIN_DEVNET_VAL_ADMIN_MNEMONIC=(
"${ADMIN0_MNEMONIC}"
"${ADMIN1_MNEMONIC}"
"${ADMIN2_MNEMONIC}"
"${ADMIN3_MNEMONIC}"
...
VAL_NODE_NUM=${#FXCHAIN_DEVNET_VAL_ADMIN_MNEMONIC[@]}

CHAIN_ID="clockend-42001"
...
then
  ...
  do
    mnemonic=${FXCHAIN_DEVNET_VAL_ADMIN_MNEMONIC[i]}
