...
fxchaind add-genesis-account $(fxchaincli keys show $KEY    -a) 100000000okt --home $HOME_SERVER
fxchaind add-genesis-account $(fxchaincli keys show admin16 -a) 900000000okt --home $HOME_SERVER
fxchaind add-genesis-account $(fxchaincli keys show admin17 -a) 900000000okt --home $HOME_SERVER
fxchaind add-genesis-account $(fxchaincli keys show admin18 -a) 900000000okt --home $HOME_SERVER
...
# fxchaincli tx send captain 0x83D83497431C2D3FEab296a9fba4e5FaDD2f7eD0 1okt --fees 1okt -b block -y
