...
(cd .. && make testnet Venus1Height=1 Venus2Height=1 EarthHeight=1)
...
fxchaincli keys add --recover admin16 -m "palace cube bitter light woman side pave cereal donor bronze twice work" -y --algo="" --coin-type 118
