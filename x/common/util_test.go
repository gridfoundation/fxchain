...
func TestHasSufCoins(t *testing.T) {
	initConfig()
	addr, err := sdk.AccAddressFromBech32("did:fury:ex1rf9wr069pt64e58f2w3mjs9w72g8vemzg70a5e")
	require.Nil(t, err)
...
func TestBlackHoleAddress(t *testing.T) {
	...
	a := addr.String()
	fmt.Println(a)
	require.Equal(t, "did:fury:ex1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqa7raw5", addr.String())
}
