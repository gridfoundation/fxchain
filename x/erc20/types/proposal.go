...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(TokenMappingProposal{}, "fxchain/erc20/TokenMappingProposal")
	govtypes.RegisterProposalTypeCodec(ProxyContractRedirectProposal{}, "fxchain/erc20/ProxyContractRedirectProposal")
	govtypes.RegisterProposalTypeCodec(ContractTemplateProposal{}, "fxchain/erc20/ContractTemplateProposal")
}
