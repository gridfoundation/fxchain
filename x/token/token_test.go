...
func TestMsgTokenChown(t *testing.T) {
	...
	tokenIssueMsg := types.NewMsgTokenIssue(common.NativeToken, common.NativeToken, common.NativeToken, "fxcoin", "1000", testAccounts[0].baseAccount.Address, true)
	...
	MsgErrorSupply := types.NewMsgTokenIssue("fxc", "fxc", "fxc", "fxccc", strconv.FormatInt(int64(10*1e10), 10), testAccounts[0].baseAccount.Address, true)
...
ok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-bok-b`,
		common.NativeToken, common.NativeToken, "fxcoin", "2100", testAccounts[0].baseAccount.Address, true)
...
func TestHandleMsgTokenIssueFails(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			types.NewMsgTokenIssue("", common.NativeToken, common.NativeToken, "fxcoin", "", testAccounts[0].baseAccount.Address, true),
		...
		{
			"Error Invalid Coins",
			types.NewMsgTokenIssue("", common.NativeToken, "a.b", "fxcoin", "9999", testAccounts[0].baseAccount.Address, true),
			"invalid coins: invalid coins: a.b",
			false,
		},
		{
			"Error Mint Coins Failed",
			types.NewMsgTokenIssue("", common.NativeToken, common.NativeToken, "fxcoin", "9999", testAccounts[0].baseAccount.Address, true),
