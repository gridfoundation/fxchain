...
type (
	...
	Token struct {
		Description         string         `json:"description" v2:"description"`                     // e.g. "Fanfury Network Utility Token"
		...
		OriginalTotalSupply sdk.Dec        `json:"original_total_supply" v2:"original_total_supply"` // e.g. 420000000.00000000
		TotalSupply         sdk.Dec        `json:"total_supply" v2:"total_supply"`                   // e.g. 420000000.00000000
		Owner               sdk.AccAddress `json:"owner" v2:"owner"`                                 // e.g. did:fury:ex1rf9wr069pt64e58f2w3mjs9w72g8vemzw26658
