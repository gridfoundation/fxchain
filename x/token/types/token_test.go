...
func TestToken(t *testing.T) {
	...
	common.InitConfig()
	addr, err := sdk.AccAddressFromBech32("did:fury:ex1jedas2n0pq2c68pelztgel8ht8pz50rhcyttfu")
	require.Nil(t, err)
	...
	testCase := []struct {
		...
		{Token{
			...
			Owner:               addr,
			Mintable:            true,
		}, `{"description":"fxblockchain coin","symbol":"` + common.NativeToken + `","original_symbol":"` + common.NativeToken + `","whole_name":"fury coin","original_total_supply":"1000000000.000000000000000000","type":0,"owner":"did:fury:ex1jedas2n0pq2c68pelztgel8ht8pz50rhcyttfu","mintable":true}`},
	}
