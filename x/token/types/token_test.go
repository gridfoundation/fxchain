...
func TestToken(t *testing.T) {
	...
	testCase := []struct {
		...
		{Token{
			Description:         "gridironblockchain coin",
			Symbol:              common.NativeToken,
			OriginalSymbol:      common.NativeToken,
			WholeName:           "fury coin",
			...
			Owner:               addr,
			Mintable:            true,
		}, `{"description":"gridironblockchain coin","symbol":"` + common.NativeToken + `","original_symbol":"` + common.NativeToken + `","whole_name":"fury coin","original_total_supply":"420000000.000000000000000000","type":0,"owner":"did:fury:ex1jedas2n0pq2c68pelztgel8ht8pz50rh7s7vfz","mintable":true}`},
	}
