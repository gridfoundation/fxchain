...
import (
	...
	cosmoscryptocodec "github.com/gridfx/fxchain/libs/cosmos-sdk/x/auth/ibc-tx"
	...
	"github.com/gridfx/fxchain/libs/cosmos-sdk/x/capability"
	...
	crisistypes "github.com/gridfx/fxchain/libs/cosmos-sdk/x/crisis"
	...
	upgradekeeper "github.com/gridfx/fxchain/libs/cosmos-sdk/x/upgrade"
	upgradetypes "github.com/gridfx/fxchain/libs/cosmos-sdk/x/upgrade"
	...
	//upgradeclient "github.com/gridfx/fxchain/libs/cosmos-sdk/x/upgrade/client"
	"github.com/gridfx/fxchain/libs/ibc-go/modules/apps/transfer"
	...
	"github.com/gridfx/fxchain/x/distribution"
	distrclient "github.com/gridfx/fxchain/x/distribution/client"
	distributionkeeper "github.com/gridfx/fxchain/x/distribution/keeper"
	distributiontypes "github.com/gridfx/fxchain/x/distribution/types"
	...
	paramproposal "github.com/gridfx/fxchain/x/params"
	paramskeeper "github.com/gridfx/fxchain/x/params"
	paramstypes "github.com/gridfx/fxchain/x/params"
...
func createTestInput(
	...
	accountKeeper := auth.NewAccountKeeper(legacyAmino, keys[authtypes.StoreKey], keys[mpt.StoreKey], subspace(authtypes.ModuleName), fxchain.ProtoAccount)
	...
	// https://github.com/gridfx/fxchain/libs/cosmos-sdk/blob/fea231556aee4d549d7551a6190389c4328194eb/x/distribution/keeper/keeper_test.go#L50-L57
