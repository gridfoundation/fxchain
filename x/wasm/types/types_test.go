...
func TestConvertAccessConfig(t *testing.T) {
	...
	did:fury:ex2, eth2 := generateAddress(1)
	...
	testcase := []struct {
		...
		{
			name:   "only 2 exaddr",
			config: AccessConfig{Permission: AccessTypeOnlyAddress, Address: strings.Join([]string{did:fury:ex1.String(), did:fury:ex2.String()}, ",")},
			expect: AccessConfig{Permission: AccessTypeOnlyAddress, Address: strings.Join([]string{eth1.String(), eth2.String()}, ",")},
			isErr:  false,
		},
		{
			name:   "only 1 exaddr 1 ethaddr",
			config: AccessConfig{Permission: AccessTypeOnlyAddress, Address: strings.Join([]string{eth1.String(), did:fury:ex2.String()}, ",")},
			expect: AccessConfig{Permission: AccessTypeOnlyAddress, Address: strings.Join([]string{eth1.String(), eth2.String()}, ",")},
			isErr:  false,
		},
		{
