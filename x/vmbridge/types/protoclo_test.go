...
func TestGetEVMABIConfig(t *testing.T) {
	testCase := []struct {
		...
		},
		{
			...
			data:      []byte("[\n  {\n    \"anonymous\": false,\n    \"inputs\": [\n      {\n        \"indexed\": false,\n        \"internalType\": \"string\",\n        \"name\": \"wasmAddr\",\n        \"type\": \"string\"\n      },\n      {\n        \"indexed\": false,\n        \"internalType\": \"uint256\",\n        \"name\": \"value\",\n        \"type\": \"uint256\"\n      },\n      {\n        \"indexed\": false,\n        \"internalType\": \"string\",\n        \"name\": \"calldata\",\n        \"type\": \"string\"\n      }\n    ],\n    \"name\": \"__GRIDCCallToWasm\",\n    \"type\": \"event\"\n  },\n  {\n    \"inputs\": [\n      {\n        \"internalType\": \"string\",\n        \"name\": \"callerWasmAddr\",\n        \"type\": \"string\"\n      },\n      {\n        \"internalType\": \"string\",\n        \"name\": \"data\",\n        \"type\": \"string\"\n      }\n    ],\n    \"name\": \"callByWasm\",\n    \"outputs\": [\n      {\n        \"internalType\": \"string\",\n        \"name\": \"response\",\n        \"type\": \"string\"\n      }\n    ],\n    \"stateMutability\": \"payable\",\n    \"type\": \"function\"\n  },{\n    \"inputs\": [\n      {\n        \"internalType\": \"string\",\n        \"name\": \"caller\",\n        \"type\": \"string\"\n      },\n      {\n        \"internalType\": \"address\",\n        \"name\": \"recipient\",\n        \"type\": \"address\"\n      },\n      {\n        \"internalType\": \"uint256\",\n        \"name\": \"amount\",\n        \"type\": \"uint256\"\n      }\n    ],\n    \"name\": \"mintERC20\",\n    \"outputs\": [\n      {\n        \"internalType\": \"bool\",\n        \"name\": \"success\",\n        \"type\": \"bool\"\n      }\n    ],\n    \"stateMutability\": \"nonpayable\",\n    \"type\": \"function\"\n  }\n]\n"),
			isErr:     true,
			expectErr: "abi must have event event __GRIDCSendToWasm",
		},
		{
			name:      "normal abi json have less call to evm event",
			data:      []byte("\t\t\t[\n    \n    {\n        \"inputs\":[\n            {\n                \"internalType\":\"string\",\n                \"name\":\"callerWasmAddr\",\n                \"type\":\"string\"\n            },\n            {\n                \"internalType\":\"string\",\n                \"name\":\"data\",\n                \"type\":\"string\"\n            }\n        ],\n        \"name\":\"callByWasm\",\n        \"outputs\":[\n            {\n                \"internalType\":\"string\",\n                \"name\":\"response\",\n                \"type\":\"string\"\n            }\n        ],\n        \"stateMutability\":\"payable\",\n        \"type\":\"function\"\n    },\n    {\n        \"anonymous\":false,\n        \"inputs\":[\n            {\n                \"indexed\":false,\n                \"internalType\":\"string\",\n                \"name\":\"wasmAddr\",\n                \"type\":\"string\"\n            },\n            {\n                \"indexed\":false,\n                \"internalType\":\"string\",\n                \"name\":\"recipient\",\n                \"type\":\"string\"\n            },\n            {\n                \"indexed\":false,\n                \"internalType\":\"uint256\",\n                \"name\":\"amount\",\n                \"type\":\"uint256\"\n            }\n        ],\n        \"name\":\"__GRIDCSendToWasm\",\n        \"type\":\"event\"\n    },\n    {\n        \"inputs\":[\n            {\n                \"internalType\":\"string\",\n                \"name\":\"caller\",\n                \"type\":\"string\"\n            },\n            {\n                \"internalType\":\"address\",\n                \"name\":\"recipient\",\n                \"type\":\"address\"\n            },\n            {\n                \"internalType\":\"uint256\",\n                \"name\":\"amount\",\n                \"type\":\"uint256\"\n            }\n        ],\n        \"name\":\"mintERC20\",\n        \"outputs\":[\n            {\n                \"internalType\":\"bool\",\n                \"name\":\"success\",\n                \"type\":\"bool\"\n            }\n        ],\n        \"stateMutability\":\"nonpayable\",\n        \"type\":\"function\"\n    }\n]\n"),
			isErr:     true,
			expectErr: "abi must have event event __GRIDCCallToWasm",
		},
		{
