...
const (
	...
	ManageContractDeploymentWhitelistProposalName = "fxchain/evm/ManageContractDeploymentWhitelistProposal"
	ManageContractBlockedListProposalName         = "fxchain/evm/ManageContractBlockedListProposal"
)
...
func RegisterCodec(cdc *codec.Codec) {
	...
	cdc.RegisterConcrete(ManageContractMethodBlockedListProposal{}, "fxchain/evm/ManageContractMethodBlockedListProposal", nil)
	cdc.RegisterConcrete(ManageSysContractAddressProposal{}, "fxchain/evm/ManageSysContractAddressProposal", nil)
	cdc.RegisterConcrete(ManageContractByteCodeProposal{}, "fxchain/evm/ManageContractBytecode", nil)
