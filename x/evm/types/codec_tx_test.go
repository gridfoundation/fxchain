...
func (ee *exAminoEncoder) name() string { return "fxchain-amino" }
...
func TestEncoder(t *testing.T) {
	...
	testEncoder(t, newTestEncoder(exAminoEnc))  // test fxchain-amino
	testEncoder(t, newTestEncoder(jsonEnc))     // test fxchain-json
}
