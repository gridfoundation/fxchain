...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(ManageContractDeploymentWhitelistProposal{}, "fxchain/evm/ManageContractDeploymentWhitelistProposal")
	govtypes.RegisterProposalTypeCodec(ManageContractBlockedListProposal{}, "fxchain/evm/ManageContractBlockedListProposal")
	govtypes.RegisterProposalTypeCodec(ManageContractMethodBlockedListProposal{}, "fxchain/evm/ManageContractMethodBlockedListProposal")
	govtypes.RegisterProposalTypeCodec(ManageSysContractAddressProposal{}, "fxchain/evm/ManageSysContractAddressProposal")
	govtypes.RegisterProposalTypeCodec(ManageContractByteCodeProposal{}, "fxchain/evm/ManageContractBytecode")
}
...
// FixShortAddr is to fix the short address problem in the FXC test-net.
// The normal len(BlockedContract.Address) should be 20,
// but there are some BlockedContract.Address in FXC test-net that have a length of 4.
