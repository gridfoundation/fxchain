...
import (
	...
	"github.com/gridfx/fxchain/x/gov/client/utils"
...
Example:
$ %s query gov proposals --depositor did:fury:ex1rf9wr069pt64e58f2w3mjs9w72g8vemzg70a5e
$ %s query gov proposals --voter did:fury:ex1rf9wr069pt64e58f2w3mjs9w72g8vemzg70a5e
...
Example:
$ %s query gov vote 1 did:fury:ex1cftp8q8g4aa65nw9s5trwexe77d9t6crp8cm05
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query gov deposit 1 did:fury:ex1rf9wr069pt64e58f2w3mjs9w72g8vemzg70a5e
`,
				version.ClientName,
			),
		),
