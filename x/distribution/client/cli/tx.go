...
Example:
$ %s tx distr set-withdraw-addr did:fury:ex1cftp8q8g4aa65nw9s5trwexe77d9t6crp8cm05 --from mykey
`,
				version.ClientName,
			),
		),
...
Example:
$ %s tx distr withdraw-rewards did:fury:exvaloper1alq9na49n9yycysh889rl90g9nhe58lcqkfpfg --from mykey 
$ %s tx distr withdraw-rewards did:fury:exvaloper1alq9na49n9yycysh889rl90g9nhe58lcqkfpfg --from mykey --commission
...
Example:
$ %s tx distr withdraw-rewards did:fury:exvaloper1alq9na49n9yycysh889rl90g9nhe58lcqkfpfg --from mykey(validator)			# withdraw mykey's commission only
$ %s tx distr withdraw-rewards did:fury:exvaloper1alq9na49n9yycysh889rl90g9nhe58lcqkfpfg --from mykey(validator&delegator)	# withdraw mykey's reward only
`,
...

{
  ...
  "recipient": "did:fury:ex1cftp8q8g4aa65nw9s5trwexe77d9t6crp8cm05",
  "amount": [
    {
      "denom": "%s",
      "amount": "10000"
