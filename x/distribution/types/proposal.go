...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(CommunityPoolSpendProposal{}, "fxchain/distribution/CommunityPoolSpendProposal")
	govtypes.RegisterProposalTypeCodec(ChangeDistributionTypeProposal{}, "fxchain/distribution/ChangeDistributionTypeProposal")
	govtypes.RegisterProposalTypeCodec(WithdrawRewardEnabledProposal{}, "fxchain/distribution/WithdrawRewardEnabledProposal")
	govtypes.RegisterProposalTypeCodec(RewardTruncatePrecisionProposal{}, "fxchain/distribution/RewardTruncatePrecisionProposal")
}
