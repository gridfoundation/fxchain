...
func RegisterConvert() {
	...
	baseapp.RegisterCmHandle("fxchain/MsgRegisterFeeSplit", baseapp.NewCMHandle(ConvertRegisterFeeSplitMsg, enableHeight))
	baseapp.RegisterCmHandle("fxchain/MsgUpdateFeeSplit", baseapp.NewCMHandle(ConvertUpdateFeeSplitMsg, enableHeight))
	baseapp.RegisterCmHandle("fxchain/MsgCancelFeeSplit", baseapp.NewCMHandle(ConvertCancelFeeSplitMsg, enableHeight))
}
