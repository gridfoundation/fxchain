...
const (
	// Amino names
	registerFeeSplitName = "fxchain/MsgRegisterFeeSplit"
	updateFeeSplitName   = "fxchain/MsgUpdateFeeSplit"
	cancelFeeSplitName   = "fxchain/MsgCancelFeeSplit"
	sharesProposalName   = "fxchain/feesplit/SharesProposal"
)
