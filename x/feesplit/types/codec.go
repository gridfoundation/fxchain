...
const (
	// Amino names
	registerFeeSplitName = "okfxchain/MsgRegisterFeeSplit"
	updateFeeSplitName   = "okfxchain/MsgUpdateFeeSplit"
	cancelFeeSplitName   = "okfxchain/MsgCancelFeeSplit"
	sharesProposalName   = "okfxchain/feesplit/SharesProposal"
)
