...
const (
	ProposalTypeUpgrade = "fxcUpgrade"
	UpgradeRouterKey    = "fxcUpgrade"

	QueryUpgrade = "fxcUpgrade"
...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(UpgradeProposal{}, "fxchain/params/UpgradeProposal")
}
