...
import (
	...
	distr "github.com/gridfx/fxchain/libs/cosmos-sdk/x/distribution"
...
func TestFullAppSimulation(t *testing.T) {
	...
	app := NewGRIDIronxChainApp(logger, db, nil, true, map[int64]bool{}, simapp.FlagPeriodValue, fauxMerkleModeOpt)
...
func TestAppImportExport(t *testing.T) {
	...
	newApp := NewGRIDIronxChainApp(log.NewNopLogger(), newDB, nil, true, map[int64]bool{}, simapp.FlagPeriodValue, fauxMerkleModeOpt)
	...
	normalizeContractInfo := func(ctx sdk.Context, app *GRIDIronxChainApp) {
		var index uint64
...
func TestAppStateDeterminism(t *testing.T) {
	...
	for i := 0; i < numTimesToRunPerSeed; i++ {
		...
		app := NewGRIDIronxChainApp(logger, db, nil, true, map[int64]bool{}, simapp.FlagPeriodValue, interBlockCacheOpt())
