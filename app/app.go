...
import (
	...
	"github.com/gridfx/fxchain/x/vmbridge"

	ica "github.com/gridfx/fxchain/libs/ibc-go/modules/apps/27-interchain-accounts"
	icacontroller "github.com/gridfx/fxchain/libs/ibc-go/modules/apps/27-interchain-accounts/controller"
	icahost "github.com/gridfx/fxchain/libs/ibc-go/modules/apps/27-interchain-accounts/host"
	"github.com/gridfx/fxchain/libs/ibc-go/modules/apps/common"
	"github.com/gridfx/fxchain/x/icamauth"

	ibccommon "github.com/gridfx/fxchain/libs/ibc-go/modules/core/common"

	icacontrollertypes "github.com/gridfx/fxchain/libs/ibc-go/modules/apps/27-interchain-accounts/controller/types"
	icahosttypes "github.com/gridfx/fxchain/libs/ibc-go/modules/apps/27-interchain-accounts/host/types"
	icamauthtypes "github.com/gridfx/fxchain/x/icamauth/types"

	icacontrollerkeeper "github.com/gridfx/fxchain/libs/ibc-go/modules/apps/27-interchain-accounts/controller/keeper"
	icahostkeeper "github.com/gridfx/fxchain/libs/ibc-go/modules/apps/27-interchain-accounts/host/keeper"
	icamauthkeeper "github.com/gridfx/fxchain/x/icamauth/keeper"

	ibcfeekeeper "github.com/gridfx/fxchain/libs/ibc-go/modules/apps/29-fee/keeper"

	icatypes "github.com/gridfx/fxchain/libs/ibc-go/modules/apps/27-interchain-accounts/types"
	ibcfeetypes "github.com/gridfx/fxchain/libs/ibc-go/modules/apps/29-fee/types"
	...
	"github.com/gridfx/fxchain/libs/cosmos-sdk/x/crisis"
	"github.com/gridfx/fxchain/libs/cosmos-sdk/x/mint"
	govclient "github.com/gridfx/fxchain/libs/cosmos-sdk/x/mint/client"
	...
	ibctransferkeeper "github.com/gridfx/fxchain/libs/ibc-go/modules/apps/transfer/keeper"
	...
	ibcclient "github.com/gridfx/fxchain/libs/ibc-go/modules/core/02-client"
	"github.com/gridfx/fxchain/libs/ibc-go/modules/core/02-client/client"
	ibcclienttypes "github.com/gridfx/fxchain/libs/ibc-go/modules/core/02-client/types"
	ibcporttypes "github.com/gridfx/fxchain/libs/ibc-go/modules/core/05-port/types"
	...
	commonversion "github.com/gridfx/fxchain/x/common/version"
	...
	fsclient "github.com/gridfx/fxchain/x/feesplit/client"
	...
	wasmclient "github.com/gridfx/fxchain/x/wasm/client"
...
const (
	appName = "FXIronxChain"
)

var (
	// DefaultCLIHome sets the default home directories for the application CLI
	DefaultCLIHome = os.ExpandEnv("$HOME/.fxchaincli")

	// DefaultNodeHome sets the folder where the applcation data and configuration will be stored
	DefaultNodeHome = os.ExpandEnv("$HOME/.fxchaind")
...
var _ simapp.App = (*FXIronxChainApp)(nil)

// FXIronxChainApp implements an extended ABCI application. It is an application
// that may process transactions through Ethereum's EVM running atop of
// Tendermint consensus.
type FXIronxChainApp struct {
	*bam.BaseApp
...
// NewFXIronxChainApp returns a reference to a new initialized FXIronxChain application.
func NewFXIronxChainApp(
	logger log.Logger,
	db dbm.DB,
	...
	codecProxy, interfaceReg := fxchaincodec.MakeCodecSuit(ModuleBasics)
	vmbridge.RegisterInterface(interfaceReg)
	// NOTE we use custom FXIronxChain transaction decoder that supports the sdk.Tx interface instead of sdk.StdTx
	...
	// use custom FXIronxChain account for contracts
	app.AccountKeeper = auth.NewAccountKeeper(
		codecProxy.GetCdc(), keys[auth.StoreKey], keys[mpt.StoreKey], app.subspaces[auth.ModuleName], fxchain.ProtoAccount,
	)
...
func (app *FXIronxChainApp) SetOption(req abci.RequestSetOption) (res abci.ResponseSetOption) {
	if req.Key == "CheckChainID" {
		if err := fxchain.IsValidateChainIdWithGenesisHeight(req.Value); err != nil {
			app.Logger().Error(err.Error())
			panic(err)
		}
		err := fxchain.SetChainId(req.Value)
		if err != nil {
			app.Logger().Error(err.Error())
			panic(err)
		}
...
func (app *FXIronxChainApp) LoadStartVersion(height int64) error {
	return app.LoadVersion(height, app.keys[bam.MainStoreKey])
}

// Name returns the name of the App
func (app *FXIronxChainApp) Name() string { return app.BaseApp.Name() }

// BeginBlocker updates every begin block
func (app *FXIronxChainApp) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
	return app.mm.BeginBlock(ctx, req)
}

// EndBlocker updates every end block
func (app *FXIronxChainApp) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// InitChainer updates at chain initialization
func (app *FXIronxChainApp) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *FXIronxChainApp) LoadHeight(height int64) error {
	return app.LoadVersion(height, app.keys[bam.MainStoreKey])
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *FXIronxChainApp) ModuleAccountAddrs() map[string]bool {
...
func (app *FXIronxChainApp) SimulationManager() *module.SimulationManager {
	return app.sm
}
...
func (app *FXIronxChainApp) GetKey(storeKey string) *sdk.KVStoreKey {
	return app.keys[storeKey]
}

// Codec returns FXIronxChain's codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *FXIronxChainApp) Codec() *codec.Codec {
	return app.marshal.GetCdc()
}

func (app *FXIronxChainApp) Marshal() *codec.CodecProxy {
	return app.marshal
}
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *FXIronxChainApp) GetSubspace(moduleName string) params.Subspace {
