...
fxchaind add-genesis-account $(fxchaincli keys show $KEY1 -a --home $HOME_CLI) 420000000fury --home $HOME_SERVER
fxchaind add-genesis-account $(fxchaincli keys show $KEY2 -a --home $HOME_CLI) 420000000fury --home $HOME_SERVER
