...
import (
	...
	cosmossdk "github.com/gridfx/fxchain/libs/cosmos-sdk/types"
	authclient "github.com/gridfx/fxchain/libs/cosmos-sdk/x/auth/client/utils"
	"github.com/gridfx/fxchain/libs/tendermint/global"
	tendertypes "github.com/gridfx/fxchain/libs/tendermint/types"
...
func TestFXIronxChainAppExport(t *testing.T) {
	db := dbm.NewMemDB()
	app := NewFXIronxChainApp(log.NewTMLogger(log.NewSyncWriter(os.Stdout)), db, nil, true, map[int64]bool{}, 0)
	...
	app2 := NewFXIronxChainApp(log.NewTMLogger(log.NewSyncWriter(os.Stdout)), db, nil, true, map[int64]bool{}, 0)
