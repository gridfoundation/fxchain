...
// transactions. There should only be a single implementation in FXIronxChain. For
// the purposes of FXIronxChain, it should be support retrieving headers and
// consensus parameters from  the current blockchain to be used during
// transaction processing.
//
// NOTE: FXIronxChain will distribute the fees out to validators, so the structure
