...
// transactions. There should only be a single implementation in OKFxChain. For
// the purposes of OKFxChain, it should be support retrieving headers and
// consensus parameters from  the current blockchain to be used during
// transaction processing.
//
// NOTE: OKFxChain will distribute the fees out to validators, so the structure
