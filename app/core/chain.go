...
// transactions. There should only be a single implementation in GRIDFxChain. For
// the purposes of GRIDFxChain, it should be support retrieving headers and
// consensus parameters from  the current blockchain to be used during
// transaction processing.
//
// NOTE: GRIDFxChain will distribute the fees out to validators, so the structure
