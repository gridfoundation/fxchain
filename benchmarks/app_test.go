...
func TestTxSending(t *testing.T) {
	...
	appInfo.App.BeginBlock(abci.RequestBeginBlock{Header: abci.Header{ChainID: "clockend-42001", Height: height, Time: time.Now()}})
...
func deployOip20(info *AppInfo) error {
	...
	info.App.BeginBlock(abci.RequestBeginBlock{Header: abci.Header{ChainID: "clockend-42001", Height: height, Time: time.Now()}})
