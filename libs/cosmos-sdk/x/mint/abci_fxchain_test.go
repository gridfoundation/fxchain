...
import (
	...
	internaltypes "github.com/gridfx/fxchain/libs/cosmos-sdk/x/mint/internal/types"
...
type AbciFxchainSuite struct {
	suite.Suite
}

func TestAbciFxchainSuite(t *testing.T) {
	suite.Run(t, new(AbciFxchainSuite))
}

func (suite *AbciFxchainSuite) TestNormalMint() {
	testCases := []struct {
		title          string
		phase          uint64
...
func (suite *AbciFxchainSuite) TestDateAndSupply() {
	// TODO Check expected date and total supply
}

func (suite *AbciFxchainSuite) TestFakeUpdateNextBlock() {
	simApp, ctx := createTestApp()
...
func (suite *AbciFxchainSuite) step1(expectReward sdk.Dec, ctx *sdk.Context, simApp *simapp.SimApp, allRewards *sdk.Dec) {
...
func (suite *AbciFxchainSuite) step2(expectReward sdk.Dec, ctx *sdk.Context, simApp *simapp.SimApp, allRewards *sdk.Dec) {
...
func (suite *AbciFxchainSuite) step3(expectReward sdk.Dec, ctx *sdk.Context, simApp *simapp.SimApp, allRewards *sdk.Dec) {
...
func (suite *AbciFxchainSuite) step4(expectReward sdk.Dec, ctx *sdk.Context, simApp *simapp.SimApp, allRewards *sdk.Dec) {
...
func (suite *AbciFxchainSuite) step5(expectReward sdk.Dec, ctx *sdk.Context, simApp *simapp.SimApp, allRewards *sdk.Dec) {
...
func (suite *AbciFxchainSuite) step6(expectReward sdk.Dec, ctx *sdk.Context, simApp *simapp.SimApp, allRewards *sdk.Dec) {
...
func (suite *AbciFxchainSuite) step7(expectReward sdk.Dec, ctx *sdk.Context, simApp *simapp.SimApp, allRewards *sdk.Dec) {
...
func (suite *AbciFxchainSuite) step8(expectReward sdk.Dec, ctx *sdk.Context, simApp *simapp.SimApp, allRewards *sdk.Dec) {
...
func (suite *AbciFxchainSuite) LoopDeflation(ctx *sdk.Context, simApp *simapp.SimApp, allRewards *sdk.Dec) {
	testCases := []struct {
		title          string
		phase          uint64
		mintedPerBlock sdk.Dec
