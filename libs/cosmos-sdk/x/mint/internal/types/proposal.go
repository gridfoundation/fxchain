...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(ManageTreasuresProposal{}, "fxchain/mint/ManageTreasuresProposal")
	govtypes.RegisterProposalTypeCodec(ModifyNextBlockUpdateProposal{}, "fxchain/mint/ModifyNextBlockUpdateProposal")
}
