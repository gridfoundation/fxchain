...
import (
	...
	fxc_types "github.com/gridfx/fxchain/libs/cosmos-sdk/x/bank/internal/types"
)
...
func (msg *MsgMultiSend) ValidateBasic() error {
	...
	if len(msg.Inputs) == 0 {
		return fxc_types.ErrNoInputs
	}
	if len(msg.Outputs) == 0 {
		return fxc_types.ErrNoOutputs
	}
...
func ValidateInputsOutputs(inputs []Input, outputs []Output) error {
	...
	if !totalIn.IsEqual(totalOut) {
		return fxc_types.ErrInputOutputMismatch
	}
