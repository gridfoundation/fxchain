...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/gridfx/fxchain/libs/cosmos-sdk/types/errors.Wrap",
		"github.com/gridfx/fxchain/libs/cosmos-sdk/types/errors.Wrapf",
		"github.com/gridfx/fxchain/libs/cosmos-sdk/types/errors.WithType",
