...
import (
	...
	sdkmaps "github.com/gridfx/fxchain/libs/cosmos-sdk/store/internal/maps"
	"github.com/gridfx/fxchain/libs/cosmos-sdk/store/mem"
	...
	"github.com/gridfx/fxchain/libs/cosmos-sdk/store/cachemulti"
	...
	"github.com/gridfx/fxchain/libs/cosmos-sdk/store/transient"
	"github.com/gridfx/fxchain/libs/cosmos-sdk/store/types"
	sdk "github.com/gridfx/fxchain/libs/cosmos-sdk/types"
	sdkerrors "github.com/gridfx/fxchain/libs/cosmos-sdk/types/errors"
	iavltree "github.com/gridfx/fxchain/libs/iavl"
...
func (rs *Store) loadVersion(ver int64, upgrades *types.StoreUpgrades) error {
	...
	if len(rs.pruneHeights) > maxPruneHeightsLength {
		return fmt.Errorf("Pruned heights length <%d> exceeds <%d>, "+
			...
			"<fxchaind data prune-compact all --home your_fxchaind_home_directory> before running fxchaind",
