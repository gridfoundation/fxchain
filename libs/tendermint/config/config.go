...
var (
	...
	DefaultLogPath     = os.ExpandEnv("$HOME/.fxchaind")
	defaultLogFileName = "fxchaind.log"
...
func (cfg *Config) SetRoot(root string) *Config {
	...
	// fxchain change LogFile base on cfg.BaseConfig.RootDir
...
func DefaultMempoolConfig() *MempoolConfig {
	return &MempoolConfig{
		...
		// ABCI Recheck
		Size:                       200_000,            // fxchain memory pool size(max tx num)
