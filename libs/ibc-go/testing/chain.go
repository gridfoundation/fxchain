...
import (
	...
	authtypes "github.com/gridfx/fxchain/libs/cosmos-sdk/x/auth/exported"
	...
	tmprototypes "github.com/gridfx/fxchain/libs/tendermint/proto/types"
	tmtypes "github.com/gridfx/fxchain/libs/tendermint/types"
	tmprotoversion "github.com/gridfx/fxchain/libs/tendermint/version"
	tmversion "github.com/gridfx/fxchain/libs/tendermint/version"
	"github.com/stretchr/testify/require"

	"github.com/gridfx/fxchain/app/crypto/ethsecp256k1"
	apptypes "github.com/gridfx/fxchain/app/types"
	fxcapptypes "github.com/gridfx/fxchain/app/types"
...
func NewTestChain(t *testing.T, coord *Coordinator, chainID string) TestChainI {
	...
	//balance = sdk.NewCoins(fxchaintypes.NewPhotonCoin(amount))
...
func NewTestEthChain(t *testing.T, coord *Coordinator, chainID string) *TestChain {
	...
	genesisAcc := &fxcapptypes.EthAccount{
