...
3. If you would like to contribute:
   ...
   4. Follow standard Github best practices: fork the repo, branch from the
      ...
      - For core developers working within the GRIDIronxChain repo, to ensure a clear
...
Take a peek at our [coding repo](https://github.com/gridironx/coding) for
...
While my fork lives at `https://github.com/rigeyrigerige/gridchain`,
the code should never exist at  `$GOPATH/src/github.com/rigeyrigerige/gridchain`.
...
For instance, to create a fork and work on a branch of it, I would:
  ...
  - `git remote add origin git@github.com:rigeyrigerige/gridchain.git`

Now `origin` refers to my fork and `upstream` refers to the GRIDIronxChain version.
So I can `git push -u origin master` to update my fork, and make pull requests to GRIDIronxChain from there.
